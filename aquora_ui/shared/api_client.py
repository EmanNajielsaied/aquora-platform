...
class AquoraAPIClient:
    ...
    def check_health(self) -> Dict[str, Any]:
        ...
        try:
            resp = requests.get(f"{self.base_url}/api/health", timeout=10.0)
    ...
    def get_water_quality_info(self) -> Dict[str, Any]:
        ...
        resp = requests.get(f"{self.base_url}/api/quality/info", timeout=15.0)
    ...
    def predict_water_quality(self, payload: Dict[str, float]) -> Dict[str, Any]:
        ...
        resp = requests.post(f"{self.base_url}/api/quality/predict", json=payload, timeout=25.0)
        resp.raise_for_status()
        return resp.json()
    ...
    def get_leak_schema(self) -> Dict[str, Any]:
        ...
        resp = requests.get(f"{self.base_url}/api/leak/schema", timeout=15.0)
        resp.raise_for_status()
        return resp.json()

    def get_leak_metrics(self) -> Dict[str, Any]:
        """Fetch model validation metrics."""
        resp = requests.get(f"{self.base_url}/api/leak/metrics", timeout=15.0)
        resp.raise_for_status()
        return resp.json()

    def predict_leak(self, features: Dict[str, Any]) -> Dict[str, Any]:
        """Run leak prediction pipeline."""
        resp = requests.post(f"{self.base_url}/api/leak/predict", json={"features": features}, timeout=25.0)
        resp.raise_for_status()
        return resp.json()
    ...
    def get_decision_schema(self) -> Dict[str, Any]:
        ...
        resp = requests.get(f"{self.base_url}/api/decision/schema", timeout=15.0)
        resp.raise_for_status()
        return resp.json()

    def get_decision_config(self) -> Dict[str, Any]:
        """Fetch expert score configuration and levels."""
        resp = requests.get(f"{self.base_url}/api/decision/config", timeout=15.0)
        resp.raise_for_status()
        return resp.json()
    ...
    def predict_decision(self, features: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resp = requests.post(f"{self.base_url}/api/decision/predict", json={"features": features}, timeout=25.0)
        resp.raise_for_status()
        return resp.json()
